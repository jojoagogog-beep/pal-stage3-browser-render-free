...
CODE_REVISION='V9_20260925_RESULT_QUEUE_192_V1'
...
def health():
    return jsonify(service='PAL_RENDER_STAGE3_BROWSER_V1',status='PASS',
                   ...
                   v9_sender_worker_revision='V9_SENDER_DEDICATED_2X_V22_PRIVACY_LABEL',
